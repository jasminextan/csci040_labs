...
def how_many_claremonts_in_url(url):
    ...
    >>> how_many_claremonts_in_url('https://web.archive.org/web/20221027142024/https://www.cmc.edu/')
    31
    >>> how_many_claremonts_in_url('https://web.archive.org/web/20221028104353/https://www.hmc.edu/')
    7
